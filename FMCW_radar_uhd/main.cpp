...
int UHD_SAFE_MAIN(int argc, char* argv[]) {
    ...
    //radar configuration
    std::string radar_config_file = "/home/david/Documents/BlackBoxRadarAttacks/FMCW_radar_uhd/Config_uhd.json";
    //std::string radar_config_file = "/home/davidh/Documents/BlackBoxRadarAttacks/FMCW_radar_uhd/Config_uhd_100MHz.json";
    
    //attacker configuration
    std::string attack_config_file = "/home/david/Documents/BlackBoxRadarAttacks/FMCW_radar_uhd/Config_uhd_attack.json";
