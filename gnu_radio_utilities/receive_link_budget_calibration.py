...
# Title: receive_link_budget_calibration
...
class receive_link_budget_calibration(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "receive_link_budget_calibration", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("receive_link_budget_calibration")
        ...
        self.settings = Qt.QSettings("GNU Radio", "receive_link_budget_calibration")
        ...
        self.blocks_nlog10_ff_1 = blocks.nlog10_ff(10, 1, (-174))
        ...
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, samp_rate)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.blocks_nlog10_ff_1, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.average_power_db, 0))
        self.connect((self.blocks_complex_to_mag_squared_0, 0), (self.blocks_moving_average_xx_0, 0))
        self.connect((self.blocks_moving_average_xx_0, 0), (self.blocks_nlog10_ff_0, 0))
        self.connect((self.blocks_nlog10_ff_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_nlog10_ff_1, 0), (self.blocks_add_xx_0, 1))
...
def main(top_block_cls=receive_link_budget_calibration, options=None):
