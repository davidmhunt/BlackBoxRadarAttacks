...
# Title: tx_link_budget_calibration
# Author: david
...
class tx_link_budget_calibration(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "tx_link_budget_calibration", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("tx_link_budget_calibration")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_link_budget_calibration")
        ...
        self.tone_frequency = tone_frequency = 10e6
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, tone_frequency, 0.5, 0, 0)
...
def main(top_block_cls=tx_link_budget_calibration, options=None):
